...
class TelemetryFrame(BaseModel):
    ...
    per_packet_retry_count: Annotated[
        int | None,
        Field(
            ge=0,
            default=None,
    ...
    neighbor_ap_count_5ghz: Annotated[
        int | None,
        Field(
            ge=0,
            default=None,
